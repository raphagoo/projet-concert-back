...
class Salle
{
     ...
     * @Groups({"event_details", "salle_details", "salle_list", "restaurantTicket_details", "event_search", "concert_details"})
     */
    private $id;
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * @Groups({"salle_details", "salle_list", "event_search", "event_details", "concert_details"})
     */
    private $city;
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * @Groups({"salle_details", "salle_list", "event_details", "concert_details"})
     */
    private $name;
